...
namespace SHM.Utilities
{
    ...
    {
        public const char ScreenshotUrisDelimeter = ';';
        public static void Configure(IMapperConfigurationExpression config = null)
        {
            ...
            config.CreateMap<RawVitaDbBrew, Brew>()
                  ...
                  .ForMember(t => t.ScreenshotUris, o => o.ResolveUsing(f => f.ScreenshotUris.Split(ScreenshotUrisDelimeter).Select(ss => Constants.VitaDbBaseUri.AppendPathSegment(ss)).ToList()));
        }
    }
}
